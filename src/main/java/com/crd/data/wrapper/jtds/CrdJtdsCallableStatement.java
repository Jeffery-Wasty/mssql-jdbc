...
import com.crd.data.wrapper.CallableStatementWrapper;
 ...
 *
 */
public class CrdJtdsCallableStatement extends CallableStatementWrapper {

	private final Connection conn;

	CrdJtdsCallableStatement(Connection conn, CallableStatement pStatement) {
		super(pStatement);
		this.conn = conn;
	}	
