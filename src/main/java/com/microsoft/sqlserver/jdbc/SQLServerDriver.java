...
enum SQLServerDriverStringProperty {
    ...
    CONFIGURED_RETRY_RULES("configuredRetryRules", ""),
    CUSTOM_CONFIG_LOCATION("customConfigLocation", ""),
...
public final class SQLServerDriver implements java.sql.Driver {
    ...
    private static final SQLServerDriverPropertyInfo[] DRIVER_PROPERTIES = {
            ...
            new SQLServerDriverPropertyInfo(SQLServerDriverStringProperty.CONFIGURED_RETRY_RULES.toString(),
                    SQLServerDriverStringProperty.CONFIGURED_RETRY_RULES.getDefaultValue(), false, null),
            new SQLServerDriverPropertyInfo(SQLServerDriverStringProperty.CUSTOM_CONFIG_LOCATION.toString(),
                    SQLServerDriverStringProperty.CUSTOM_CONFIG_LOCATION.getDefaultValue(), false, null),
